...
**Lớp:** 3A · **Phòng:** E402 · **Cụm:** C3 · **Track:** A

| Họ và Tên       | Mã Học Viên | Vai trò chính           | Phần việc đảm nhiệm trong dự án                                                                                                                                               |
| --------------- | ----------- | ----------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Ngụy Quang Hùng | 2A202602998 | Lead/Product            | Trưởng nhóm, chốt hướng Track A và lát cắt sản phẩm, phân công công việc, theo dõi tiến độ checkpoint, rà soát`README.md`, `spec.md`, prototype, eval và video trước khi nộp. |
| Nguyễn Văn Việt | 2A202602904 | Spec/Workflow/Evidence  | Phụ trách`spec.md`, tham gia thiết kế workflow chính của sản phẩm, quay video CP2, tổng hợp nội dung spec, phối hợp làm Google Form và thu thập khảo sát/evidence.            |
| Hà Huy Nhất     | 2A202602401 | Backend/AI Integration  | Chỉnh sửa`codebase/server.mjs`, xử lý luồng gọi AI/API, kiểm tra trace AI, hỗ trợ chỉnh giao diện prototype, phối hợp làm Google Form và thu thập khảo sát/evidence.          |
| Đinh Xuân Quyền | 2A202602358 | Prototype UI/Evaluation | Thiết kế giao diện prototype trong`codebase/index.html`, hoàn thiện flow demo, xây dựng case lỗi, phụ trách `eval/`, kiểm tra case happy/failure, quay video CP3 và CP5.      |
